...
function UpdateBedData() {
    ...
    const [bedData, setCovidBedData] = useState({
        ...
        totBeds: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.totBeds?covidBedData.CovidBedData.covidBedData.hospitalBedData.totBeds:0,
        ocupBeds: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.ocupBeds?covidBedData.CovidBedData.covidBedData.hospitalBedData.ocupBeds:0,
        vacBeds: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.vacBeds?covidBedData.CovidBedData.covidBedData.hospitalBedData.vacBeds:0,
        icuBeds: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.icuBeds?covidBedData.CovidBedData.covidBedData.hospitalBedData.icuBeds:0,
        oxygenBed: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.oxygenBed?covidBedData.CovidBedData.covidBedData.hospitalBedData.oxygenBed:0,
        normalBed: covidBedData?.CovidBedData?.covidBedData?.hospitalBedData?.normalBed?covidBedData.CovidBedData.covidBedData.hospitalBedData.normalBed:0,
